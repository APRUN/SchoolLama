    ...
    <div className='flex items-center justify-between p-4 '>
        ...
        <div className="flex gap-4 items-center justify-end w-full">
            ...
            <div className="bg-white relative rounded-full w-7 h-7 items-center justify-center flex cursor-pointer">
                ...
                <div className="absolute -top-3 -right-3 bg-purple-500 w-5 h-5 justify-center flex items-center rounded-xl text-white cursor-pointer text-xs">1</div>
            </div>
            <div className="flex flex-col">
                <span className="text-xs leading-3 font-medium">Chief Oggy</span>
